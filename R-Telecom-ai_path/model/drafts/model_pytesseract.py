...
pytesseract.pytesseract.tesseract_cmd = r'C:\Program Files\Tesseract-OCR\tesseract.exe'  # Укажите свой путь к Tesseract
...
# Функция для извлечения текста с изображения с помощью Tesseract OCR
...
def main():
    ...
    output_file = 'texts\img_4_text_TESS.txt'  # Название файла для сохранения текста
